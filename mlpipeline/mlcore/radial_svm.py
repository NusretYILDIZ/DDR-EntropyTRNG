...
from config import RadialSvm as RadialSvmConfig
...
class RadialSvmModel(MlModel):
    _name = "RadialSvm"
    _model: SVC

    def __init__(self) -> None:
        self._model = SVC(C=RadialSvmConfig.get("C"), gamma=RadialSvmConfig.get("gamma"), kernel=RadialSvmConfig.get("kernel"))
